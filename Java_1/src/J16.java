...
public class J16 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        List<String> goldMedalist=new ArrayList<>();
        ...
        for (int i=0;i<len1;i++){
            totalMarks.add(engMarks.get(i)+matMarks.get(i)+phyMarks.get(i)+cheMarks.get(i)+bioMarks.get(i));
        }
        ...
        totalMax= Collections.max(totalMarks);
        ...
        for (int i=0;i<len1;i++){
            ...
            if (totalMarks.get(i)==totalMax){
                goldMedalist.add(names.get(i));
            }
        }
        ...
        System.out.println();
        System.out.print(goldMedalist+" are the gold medalist with total marks: "+totalMax);
    }
}